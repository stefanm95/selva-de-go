        ...
        <Reveal variants={staggerContainer} className='relative z-20'>
          <div className='grid gap-16 xl:grid-cols-12'>
            <div className='xl:col-span-5'>
              <Cinematic delay={0.1}>
                <div className='rounded-[3rem] border border-white/10 bg-[var(--surface-warm)]/70 p-12 shadow-[0_32px_70px_rgba(34,19,10,0.09)] backdrop-blur-xl'>
                  <div className='mb-10 flex items-center gap-4'>
                    <div className='h-[4px] w-16 rounded-full bg-[var(--brand-orange-hot)]' />
                  ...
                  <p className='mt-12 text-[1.05rem] leading-[1.95] text-[var(--text-earth)]/82'>
                    {scene.description}
                  </p>
                </div>
              </Cinematic>
            ...
            <div className='xl:col-span-7 grid gap-8'>
                ...
                <FadeIn delay={0.14}>
                  <article className='relative overflow-hidden rounded-[3rem] border border-white/10 bg-white/8 p-10 shadow-[0_32px_70px_rgba(32,18,12,0.08)] backdrop-blur-xl'>
                    ...
                    <div className='relative z-10'>
                      <p className='text-[2rem] font-semibold leading-[1.05] text-[var(--text-primary)]'>
                        {fragments[0].title}
                      </p>
                      <p className='mt-5 text-[1rem] leading-[1.95] text-[var(--text-earth)]/82'>
                        {fragments[0].text}
                      </p>
                    </div>
                  </article>
              ...
              <div className='grid gap-8 lg:grid-cols-[0.75fr_0.85fr]'>
                ...
                <div className='grid gap-8'>
                  <FadeIn delay={0.26}>
                    <div className='rounded-[3rem] border border-white/10 bg-[var(--surface-warm)]/80 p-10 shadow-[0_28px_60px_rgba(31,19,12,0.09)] backdrop-blur-xl'>
                      <p className='text-[2.4rem] font-semibold text-[var(--text-primary)]'>
                        {scene.stats[0].value}
                      </p>
                      <p className='mt-3 text-sm uppercase tracking-[0.25em] text-[var(--brand-berry)]/80'>
                        {scene.stats[0].label}
                      </p>
                    </div>
                  </FadeIn>
